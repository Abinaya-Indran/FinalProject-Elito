...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  heading: { textAlign: "center", fontSize: "24px", marginBottom: "30px" },
  emptyCart: { textAlign: "center", fontSize: "18px", color: "#888" },
  cartTable: { width: "100%", borderCollapse: "collapse", marginBottom: "30px" },
  tableHeader: { borderBottom: "2px solid #ddd", textAlign: "left", padding: "10px", color: "#a64ca6" },
  tableCell: { borderBottom: "1px solid #ddd", padding: "10px", verticalAlign: "top" },
  ...
  productName: { fontSize: "16px", fontWeight: "bold", color: "#a64ca6", margin: "0" },
  ...
  summaryText: { fontSize: "16px", margin: "5px 0", display: "flex", justifyContent: "space-between" },
  taxInfo: { fontSize: "12px", color: "#555", marginTop: "5px" },
  buyButton: { padding: "10px 20px", border: "none", cursor: "pointer", fontSize: "16px", borderRadius: "4px", backgroundColor: "#a64ca6", color: "white" },
};
